...
This folder turns the product direction in `README.md` into execution artifacts.
...
Default execution rule: keep product direction in `README.md`, engineering policy in `AGENTS.md`, and implementation-specific decisions in this `docs/` folder.
