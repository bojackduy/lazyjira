...
- Add app entrypoint.
- Add root app shell.
- Add placeholder route/screen state for workspace, active sprint, backlog, board, and issue detail.
...
- [ ] Shared state shape has routes for `workspace`, `active-sprint`, `backlog`, `kanban`, and `issue-detail`.
