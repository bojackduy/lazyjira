...
export function paletteCommandsForBoard(board: BoardType | { type: BoardType } = "scrum"): readonly PaletteCommand[] {
  ...
  return [
    ...
    command("app.report-bug", "Report a bug", "Open a prefilled GitHub issue report.", "B", "Global"),
    command("theme.change", "Change theme", "Preview and select a built-in or custom theme.", "T", "Global", { group: "route", name: "config" }),
