...
function printRootHelp() {
  ...
  console.log("")
  console.log("Usage:")
  console.log("  lazyjira                 Open the TUI in prod runtime")
  console.log("  lazyjira prod            Open the TUI in prod runtime")
  console.log("  lazyjira dev             Open the TUI in dev runtime with fixtures")
